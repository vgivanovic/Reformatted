% %%% Time-stamp: <2024-01-17 09:21:58 vladimir>
...
\end{enumerate}\index{research question!redux}

\section{Key Findings}\label{sec:summary-key-findings}\indent % chktex 24
...
If no illegal activities were detected,  who actually benefits from Rocketship's growth in net assets?\index{key finding|)}
...
However, this is likely no longer correct because a plain reading of current law doesn't allow nonprofits to benefit private individuals.\footnote{Here are a few excerpts from IRS regulations and California law.
...
\end{itemize}\index{public policy!changes to}
