%% Time-stamp: <2023-07-03 17:44:57 vladimir>
...
\subsubsection{Board and Committee Material}\label{sec:board-committee-packets}\indent

Rocketship publishes on their website, as required by California's Brown Act, agendas and supporting material for its board meetings and for certain\footnote{The Brown Act requires board-appointed committee meetings to be open if they are standing meetings whose subject matter is within the jurisdiction of Rocketship's Board or if a majority or more are members of the committee.} committee meetings. Currently, Rocketship only provide this data going back to February 2017. However, they previously had made available material going back to 2006, and it is this data which will be part of this study.
