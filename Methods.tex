...
%%% Time-stamp: <2024-01-17 09:19:01 vladimir>
...
The most succinct summary of how LCFF amounts are calculated is given by the \textcite{CDE2023a}:
\begin{quotation}
...
The intricacies of LCFF funding are covered in more detail in Chapter 3 of Aguinaldo.etal (2022), %[pp. 35–58]%
\index{LCFF|)}
...
\begin{itemize}
  ...
  \index{California!Department of Education}
  \index{California!State Board of Education}
  \item The County of Santa Clara and the Santa Clara County Office of Education{Santa Clara County}\index{Santa Clara County!Office of Education}
  \item The California Open Data Portal\index{California!Open Data Portal}
  \item National Center for Education Statistics (NCES) at the Institute for Education Sciences (IES)\index{Institute for Education Sciences (IES)!Nation Center for Education Statistics (NCES)}
  \item Stanford Educational Data Archive (SEDA)\index{Stanford Educational Data Archive (SEDA)}
  \item School Finance Indicators Database\index{School Finance Indicators Database}
  \item EdSource, Ed-Data, and other aggregators of educational data specific to California
  \index{EdSource}\index{Ed-Data}
\end{itemize}
\index{data sets|)}
