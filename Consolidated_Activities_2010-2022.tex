%%% Time-stamp: <2024-06-30 11:48:05 vladimir>
...
\begin{sidewaystable}
  \centering
    ...
    \includegraphics[page=1,scale=0.75,keepaspectratio]{Consolidated_Activities_2010-2022} %chktex 8
  \end{sidewaystable}

  \begin{sidewaystable}
  \centering
    \caption*{\textit{Consolidated Activities, Years Ending 2010-2022, cont'd}} %chktex 8
    \includegraphics[page=2,scale=0.75,keepaspectratio]{Consolidated_Activities_2010-2022} %chktex 8
  \end{sidewaystable}

  \begin{sidewaystable}
  \centering
    \caption*{\textit{Consolidated Activities, Years Ending 2010-2022, cont'd}} %chktex 8
    \includegraphics[page=3,scale=0.75,keepaspectratio]{Consolidated_Activities_2010-2022} %chktex 8
  \end{sidewaystable}
  ...
  \centering
    ...
    \includegraphics[page=4,scale=0.75,keepaspectratio]{Consolidated_Activities_2010-2022} %chktex 8
  \end{sidewaystable}
