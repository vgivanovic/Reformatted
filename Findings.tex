% %%% Time-stamp: <2023-06-13 13:04:11 vladimir>
...
\begin{figure}[ht]
  \centering
  \caption{Rocketship's Corporate Structure (Santa Clara County only)}\label{fig:RSED-corporate-structure}
...
\begin{table}[thb]
  ...
  \begin{tabular}{lll}
    ...
    Sí Se Puede     & 2249 Dobern Ave, San José, CA 95116   & \prettyref{sec:sí-si-puede-info} \\
