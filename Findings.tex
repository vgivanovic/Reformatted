% Time-stamp: <2023-11-22 19:02:29 vladimir>
...
This section is concerned with what wasn't found during our investigation. Gaps would be where data were expected, but none were found. Anomalies are where data were found, but differed from what were expected, and discrepancies are where data were found but conflicted with other data.
...
Gaps are where data were expected, but not found.
