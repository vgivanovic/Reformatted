%%% Time-stamp: <2023-07-16 15:34:56 vladimir>
...
This chapter will present the data found using the approach outlined in \prettyref{chap:methods} with the goal of answering my research question: Has Rocketship structured itself and its finances, to earn a return to investors, focusing especially on real estate transactions, and if so, how?
...
\begin{figure}
  \centering
  \caption[Financial Statements Collected \& Summarized] {\textit{Financial Statements Collected \& Summarized} \label{fig:financial-statements-collected}
 \includegraphics[width=\textwidth]{Consolidated_Financial_Statements/Financial_Statements_Collected_\&_Summarized.pdf}\\ %chktex 8
\end{figure}
