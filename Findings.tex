% Time-stamp: <2023-09-22 13:27:54 vladimir>
...
\todo{What is a plausible exit strategy for Rocketship's investors?}
...
\todo{Change the chaptername of the appendices to be ``Appendix''}
\todo{Remove ``Part I'` from the beginning of the appendices.}
\todo{Check and re-check the RSEA consolidated spreadsheets.}
\todo{Add 2008-2018 Functional Expenses summary, if time permits.}
\todo{Fix the ordering of the figures and tables.}
...
\section{Rocketship's Finances}\label{sec:rocketship_finances}\indent
...
\begin{table}[hbt]
  ...
  \begin{tabular}{lccl}
    ...
    \\
    Construction loans   & Yes  & Yes                        & \multirow[t]{2}{3in}{Typically bonds, with widely varing 
...
The first three sources of financing listed above are considered ordinary revenue and are available to both public schools and to charter schools, although the amounts and timing of the distributions might vary.
...
and their annual, consolidated financial statements provide debt summaries starting in 2012. The totals are shown in \prettyref{tab:total_debt}. 

\begin{table}[hbt]\caption{Total Debt, 2012-2022}\label{tab:total_debt}
  \begin{tabular}{ll}
    \toprule
