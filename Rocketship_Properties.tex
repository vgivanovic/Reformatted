%%% Time-stamp: <2024-01-16 15:37:15 vladimir>
%%% Copyright (C) 2019-2024 Vladimir G. Ivanović
%%% Author: Vladimir G. Ivanović <vladimir@acm.org>
%%% ORCID: https://orcid.org/0000-0002-7802-7970

\chapter{Rocketship's Santa Clara Properties}\label{appx:rocketship-property-info}

Each of the 10 existing Rocketship schools in Santa Clara County which were listed in \prettyref{tab:locations} are described in this appendix.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
\renewcommand{\CRB@setcopyrightfont}{\color[gray]{0.5}\scriptsize}
\makeatother
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/mateo-sheedy-plat-map-264-34}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Satellite-Photos/mateo-sheedy-sat-photo}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/sí-se-puede-plat-map-481-32}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[height=0.667\textheight]{Satellite-Photos/sí-se-puede-sat-photo}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/los-sueños-plat-map-481-45}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Satellite-Photos/los-sueños-sat-photo}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/discovery-prep-plat-map-249-65}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Satellite-Photos/discovery-prep-sat-photo}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/mosaic-plat-map-477-34}}
...
\begin{figure}[ht]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Satellite-Photos/mosaic-sat-photo}}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{ll}
    ...
    \bottomrule
  \end{tabular}\\\newline
  \noindent{Note: Brilliant Minds occupies a single parcel, along with two churches. It appears to have its own buildings, but shares the single parking lot. The size of the parcel is 2.446ac, and arbitrarily, half has been allocated to Rocketship Brilliant Minds.}  
\end{table}
...
\begin{figure}[t]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/brilliant-minds-plat-map-488-03}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/alma-academy-plat-map-434-22}}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{llll}
    ...
    \bottomrule
  \end{tabular}\\\newline
  \noindent{Note: Rocketship Alma Academy comprises six adjacent parcels, so the assessed value indicated in this table is the sum of all six parcels.}
\end{table}
...
\begin{figure}[hbtp]
    ...
    \copyrightbox[b]
    {\includegraphics[height=0.5\textheight]{Satellite-Photos/alma-academy-sat-photo}}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{ll}
    ...
    \bottomrule
  \end{tabular}\\
  \noindent{Note: Spark Academy has a land lease from the Franklin McKinley School District, so the figures above enclosed in brackets are those of the Franklin McKinley School District.}  
\end{table}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/spark-academy-plat-map-494-72}}
  {Santa Clara County Assessor's Office (n.d.). [Plat Map]. Retrieved 07 Jan 2023 from  \url{https://tinyurl.com/spark-academy-plat-map}.}
    ...
    \noindent{Note: The outline is approximate.}
  \end{figure}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{llll}
    ...
    \bottomrule
  \end{tabular}\\
  \noindent{Note: As noted above, Spark Academy leases its land from the Franklin McKinley School District. Since public school districts are exempt from property taxes, all the taxable amounts in this table are listed as \$0.}
\end{table}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[height=0.5\textheight]{Satellite-Photos/spark-academy-sat-photo}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/fuerza-plat-map-484-41}}
...
\begin{figure}[hbtp]
  ...
  {Google. (n.d). [Google Earth image]. Retrieved 07 Jan 2023 from \url{https://tinyurl.com/fuerza-v2}}.
\end{figure}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[width=0.95\textwidth]{Assessor-Info/rising-stars-plat-map-494-01}}
...
\begin{figure}[hbtp]
  ...
  \copyrightbox[b]
  {\includegraphics[height=0.5\textheight]{Satellite-Photos/rising-stars-sat-photo}}
