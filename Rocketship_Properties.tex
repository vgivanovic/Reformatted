%%% Time-stamp: <2023-07-11 15:17:15 vladimir>
...
\clearpage
k\section{[Sí Se Puede}\label{sec:śi-se-puede-plat-map}\indent
...
\begin{figure}[hbt]
  ...
  \includegraphics[width=0.9\textwidth]{Assessor-Info/sí-puede-plat-map-481-32}\\ %chktex 8
...
\begin{table}[htb]
  \SingleSpacing%
  \caption[Sí Se Puede: Taxable Amount of Assessed Propertsy]{\textit{Sí Se Puede: Taxable Amount of Assessed Property}}\label{tab:sí-se-puede-taxable-amount}
  \begin{tabular}{llll}
    \toprule
    Year & Land        & Improvements & Total Assessed Value \\
    \midrule
